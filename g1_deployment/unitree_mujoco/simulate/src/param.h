...
// Mutex to synchronize access to mjData between physics thread and bridge thread.
// Must be locked around mj_step() and around sensor data reads in the bridge.
inline std::mutex physics_mutex;
